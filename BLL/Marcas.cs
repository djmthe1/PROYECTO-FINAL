...
namespace BLL
{
    public class Marcas : ClaseMaestra
    {
        ...
        public DataTable ObtenerMarcaId(string Descripcion)
        {
            return conexion.ObtenerDatos(String.Format("select MarcaId from Marcas where Descripcion ='{0}'", Descripcion));
        }
