...
namespace BLL
{
    public class NumerosTelefono : ClaseMaestra
    {
        ...
        public NumerosTelefono(int id, int clienteId, string telefono)
        {
            this.Id = id;
        ...
        public override bool Buscar(int IdBuscado)
        {
            ...
            if (datos.Rows.Count > 0)
            {
                ...
                this.ClienteId = (int)datos.Rows[1]["ClienteId"];
